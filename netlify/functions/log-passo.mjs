...
export default async (req) => {
  try {
    ...
    const vistosAntes = (atual && atual.passosVistos) || [];
    const passosVistos = vistosAntes.indexOf(passo) === -1 ? vistosAntes.concat([passo]) : vistosAntes;
    const registro = {
      id,
      ...
      passosVistos,
      dev: !!body.dev,
      meuNome: body.meuNome || (atual && atual.meuNome) || null,
      parceiroNome: body.parceiroNome || (atual && atual.parceiroNome) || null,
